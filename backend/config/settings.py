...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-flujex-dev-key")
...
MIDDLEWARE = [
    ...
    # Para desarrollo local con login por sesión desde React.
    # En producción conviene reactivar CSRF y usar token CSRF correctamente.
